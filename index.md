...
- Among-individual variation in the swimming behaviour of the amphipod
  *Gammarus pulex* under dark and light conditions, [Science of The
  Total Environment,
  2023](https://doi.org/10.1016/j.scitotenv.2023.162177).
- Effects of the antidepressant fluoxetine on the swimming behaviour of
  the amphipod *Gammarus pulex*: Comparison of short-term and long-term
  toxicity in the laboratory and the semi-field, [Science of The Total
  Environment, 2023](https://doi.org/10.1016/j.scitotenv.2023.162173).

Please cite if you use it. You can do this easily with one of these
options:

- The `cite this repository` menu in the right tab.
- The [citation file](https://pabrod.github.io/kinematics/CITATION.cff).
...
In order to use the package, we have to install it. The package is in
CRAN, so we can install it easily by typing:
...
This package takes trajectories and returns a whole set of kinematical
features. \### Input

The input is a data frame like the one below (see subsection *Movement
and how to store it* below):
...
When the input is fed to the `append_dynamics` function, the output
extends the original data frame with all the extra dynamical information
available in the package:

| t       | x         | y         |     | Velocity   | Acceleration | Curvature | Displacement |
|---------|-----------|-----------|-----|------------|--------------|-----------|:-------------|
| $t_{0}$ | `<float>` | `<float>` |     | `<vector>` | `<vector>`   | `<float>` | `<vector>`   |
| $t_{1}$ | `<float>` | `<float>` |     | `<vector>` | `<vector>`   | `<float>` | `<vector>`   |
| $t_{2}$ | `<float>` | `<float>` |     | `<vector>` | `<vector>`   | `<float>` | `<vector>`   |
| $t_{3}$ | `<float>` | `<float>` |     | `<vector>` | `<vector>`   | `<float>` | `<vector>`   |
| …       | …         | …         |     | …          | …            | …         | …            |
...
![](reference/figures/parabolic-plot-1.png)
...
![](reference/figures/ggplot-1.png)
...
![](reference/figures/spiral-plot-1.png)
...
![](reference/figures/spiral-ggplot-1.png)
...
![](reference/figures/load-data-1.png)
...
![](reference/figures/plot-data-1.png)
...
![](reference/figures/hist-data-1.png)

## Citation

Please use the information below to compose your citation of this
software.
...
Different citation formats can be automatically generated from
[Zenodo](https://doi.org/10.5281/zenodo.5107804).

## Authors

- [Pablo Rodríguez-Sánchez](https://pabrod.github.io)
- [Sanne J.P. van den
  Berg](https://www.wur.nl/en/Persons/Sanne-dr.-SJP-Sanne-van-den-Berg.htm)

## License

This project is licensed under the MIT License - see the
[LICENSE.md](https://pabrod.github.io/kinematics/LICENSE) file for
details
